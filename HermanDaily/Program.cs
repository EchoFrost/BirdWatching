...
namespace HermanDaily
{
    public static class Program
    {
        public static async Task Main(string[] args)
        {
            // Start our application stopwatch.
            ...
            {
                File.AppendAllText(LogFile, "No API consumer secrety specified." + Environment.NewLine);
                return;
            }
        ...
        private static string SelectRandomImage()
        {
            ...
            var hermanImages = Directory.GetFiles(ImageDirectory, "*.jpg");

            // Verify we found any images.
            if (hermanImages == null || hermanImages.Length < 1)
            {
                return null;
            }

            // Pick a random image.
            return hermanImages[rand.Next(hermanImages.Length)];
        }
